...
//        this.crudService.Save(emprestimo);
   ...
   // @Test
    ...
    public void getRequestTest() throws Exception
    {
        ...
        Calendar ca = Calendar.getInstance();
        EstadoPedido estadoPedido = new EstadoPedido();
        TipoRequisicao tipoRequisicao = this.crudService.get(TipoRequisicao.class, 1);
        estadoPedido.setIdestadopedido(4);
        emprestimoPK.setDataentrada(ca);
        emprestimoPK.setUser(this.crudService.get(Users.class, 2));
        emprestimoPK.setObra(this.crudService.get(Obra.class, "eee2"));
        ...
        this.eCSingleton.saveEmprestimo(emprestimo);

        EmprestimoPK emprestimoPK1 = new EmprestimoPK();
        Emprestimo emprestimo1 = new Emprestimo();

        estadoPedido.setIdestadopedido(4);
        emprestimoPK1.setDataentrada(ca);
        emprestimoPK1.setUser(this.crudService.get(Users.class, 3));
        emprestimoPK1.setObra(this.crudService.get(Obra.class, "eee2"));
        emprestimo1.setEmprestimoPK(emprestimoPK1);
        emprestimo1.setEstadoPedido(estadoPedido);
        emprestimo1.setTipoRequisicao(tipoRequisicao);

        this.eCSingleton.saveEmprestimo(emprestimo1);

        assertThat(this.eCSingleton.getRequest(emprestimoPK)).isNotEqualTo(null);
