...
public class ListPedido extends SelectorComposer<Component> {
    ...
    public void ComposeUserAdmin(){
        pedidoListModel = new ListModelList<Emprestimo>(request.getRequest(ePController.PENDING));
        pedidoListBox.setModel(pedidoListModel);
    }

    public void ComposeUserNormal() {
        pedidoListModel = new ListModelList<Emprestimo>(request.getRequest(this.user, ePController.PENDING));
        pedidoListBox.setModel(pedidoListModel);
    }
